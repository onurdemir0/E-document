...
namespace E_document.UI
{
	partial class frmCreateBill
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlBillinfo.Controls.Add(this.comboBoxScenario);
			...
			// lblBillType
			// 
			resources.ApplyResources(this.lblBillType, "lblBillType");
			...
			// lblEttnNo
			// 
			resources.ApplyResources(this.lblEttnNo, "lblEttnNo");
			...
			// lblEttn
			// 
			resources.ApplyResources(this.lblEttn, "lblEttn");
			this.lblEttn.Name = "lblEttn";
			// 
			// lblBillTitle
			// 
			resources.ApplyResources(this.lblBillTitle, "lblBillTitle");
			...
			// lblOrderDa
			// 
			resources.ApplyResources(this.lblOrderDa, "lblOrderDa");
			...
			// btnAddToAddressBook
			// 
			resources.ApplyResources(this.btnAddToAddressBook, "btnAddToAddressBook");
			...
			// lblSearchCustomer
			// 
			resources.ApplyResources(this.lblSearchCustomer, "lblSearchCustomer");
			...
			// dtpWayBillDate
			// 
			resources.ApplyResources(this.dtpWayBillDate, "dtpWayBillDate");
			this.dtpWayBillDate.Name = "dtpWayBillDate";
			this.dtpWayBillDate.ValueChanged += new System.EventHandler(this.dtpWayBillDate_ValueChanged);
			// 
			// txtWayBillNo
			// 
			resources.ApplyResources(this.txtWayBillNo, "txtWayBillNo");
			this.txtWayBillNo.Name = "txtWayBillNo";
			this.txtWayBillNo.TextChanged += new System.EventHandler(this.txtWayBillNo_TextChanged);
			this.txtWayBillNo.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtWayBillNo_KeyPress);
			// 
			// lblWayBillDate
			// 
			resources.ApplyResources(this.lblWayBillDate, "lblWayBillDate");
			this.lblWayBillDate.Name = "lblWayBillDate";
			// 
			// lblWayBillNo
			// 
			resources.ApplyResources(this.lblWayBillNo, "lblWayBillNo");
			this.lblWayBillNo.Name = "lblWayBillNo";
			// 
			// lblWaybillInfo
			// 
			resources.ApplyResources(this.lblWaybillInfo, "lblWaybillInfo");
			...
			// lblVatRate
			// 
			resources.ApplyResources(this.lblVatRate, "lblVatRate");
			...
			// lblItemNo
			// 
			resources.ApplyResources(this.lblItemNo, "lblItemNo");
			this.lblItemNo.Name = "lblItemNo";
			// 
			// lblProductTitle
			// 
			resources.ApplyResources(this.lblProductTitle, "lblProductTitle");
			...
			// txtIncludingTaxes
			// 
			resources.ApplyResources(this.txtIncludingTaxes, "txtIncludingTaxes");
			...
			// txtCalculatedVAT
			// 
			resources.ApplyResources(this.txtCalculatedVAT, "txtCalculatedVAT");
			...
			// lblCalculationTitle
			// 
			resources.ApplyResources(this.lblCalculationTitle, "lblCalculationTitle");
			...
			// lblSearchSender
			// 
			resources.ApplyResources(this.lblSearchSender, "lblSearchSender");
		...
		private System.Windows.Forms.TextBox txtPayeeAcc;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.Label lblPayeeInfo;
